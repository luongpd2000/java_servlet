...
<main>
    <!-- Modal -->
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe"
         aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabe">Chi tiết sản phẩm</h5>
                ...
                <div class="modal-body form-custom">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Giá</label>
                                <input type="number" class="form-control" id="number-gia" placeholder="Nhập giá"
                                       min="0">
                                <div class="invalid-feedback">
                                    Error!
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Đã bán</label>
                                <input type="number" class="form-control" id="number-da-ban" placeholder="Nhập số lượng"
                                       min="0">
                                <div class="invalid-feedback">
                                    Error!
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="number-bao-hanh"
                                       placeholder="Nhập thời lượng" min="0">
                                <div class="invalid-feedback">
                                    Error!
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="number-khuyen-mai"
                                       placeholder="Nhập khuyến mãi" min="0">
                                <div class="invalid-feedback">
                                    Error!
                                </div>
                            </div>
    ...
    <div class="tool-page">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <button type="button" class="btn btn-primary" id="btn-them"><i class="fas fa-plus"></i> Thêm sản
                        phẩm
                    </button>
                </div>
                    ...
                    <div class="table-reponsive">
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <td><input type="number" class="form-control" id="number-search-gia" min="0" value="0">
                                </td>
                                <td><input type="number" class="form-control" id="number-search-da-ban" min="0"
                                           value="0"></td>
                                <td>
